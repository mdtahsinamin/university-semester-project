...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("/api/v1/auth/user-login", { email, password }, config);
...
export const userRegister = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`/api/v1/auth/user-register`, userData, config);
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/api/v1/auth/update-profile`, userData, config);
...
export const updatePassword = (password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/api/v1/auth/update-password`, password, config);
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`/api/v1/auth/admin/role/${id}`, userData, config);
